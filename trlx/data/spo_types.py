...
@dataclass
class SPORLElement:
    """Separate rollout query from train query!

    :param rollout_query_tensor: The rollout query tensor i.e. the prompt tokens.
                         Should be a long tensor.
    :type rollout_query_tensor: torch.Tensor
    ...
    rollout_query_tensor: TensorType["rollout_query_size"]
...
class SPORLBatch:
    """
    A batched version of the SPORLElement. See SPORLElement for more details on individual fields.
    ...
    rollout_query_tensors: TensorType["batch_size", "rollout_query_size"]
